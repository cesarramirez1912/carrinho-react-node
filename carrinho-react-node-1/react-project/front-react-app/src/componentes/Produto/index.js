                        ...
                        <tr key={item.id_produto}>
                              <td>
                                 {item.id_produto}
                                   ...
                                   <td>
                                      <Button color="info"  onClick={event => this.props.eventoEditarProduto({id_produto:item.id_produto,descricao:item.descricao,preco:item.preco,index})} size="sm">editar</Button>{' '}
                                      <Button color="danger" onClick={event => this.props.eventoRemoveProduto(item.id_produto,index)} size="sm">deletar</Button>{' '}
                                      <Button color="success" onClick={event => this.props.eventoAddCarrinho(item.id_produto)} size="sm">carrinho</Button>
                                   </td>
               ...
               <h5 className="text-light mb-2">Descricao</h5>
                <form id="id-form">
                   <InputGroup className="mb-2">
                    ...
                    {this.props.controle.botaoCadastrar ? <Button className="w-100 mt-3 bg-success" onClick={(event)=> this.props.eventoAddProduto(event)}>Cadastrar</Button> : <Button className="w-100 mt-3 bg-info" onClick={this.clickEdit}>Registrar</Button>}
                </form>
               </Col>
              </Row>
            </div>
